...
2. 调用上下文管理器的 \_\_enter\_\_() 方法；如果使用了 as 子句，则将 \_\_enter\_\_() 方法的返回值赋值给 as 子句中的 target(s)
...
需要注意的是，发生异常后，如果某个上下文管理器的 \_\_exit\_\_() 方法对异常处理返回 False，则更外层的上下文管理器不会监测到异常。
